...
public class Simple {
    ...
    public static void main(String[] args) throws Exception {
        String json = "{\"header\":{\"code\":\"200\"},\"body\":{\"log_page\":{\"current_page\":1},\"data\":{\"1200630898788598\":{\"page\":1}}}}";
        System.out.println(JacksonUtils.fromJson(json, new TypeReference<Test>() {
        }));
    }
